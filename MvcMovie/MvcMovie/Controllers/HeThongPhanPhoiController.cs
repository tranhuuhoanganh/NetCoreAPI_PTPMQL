...
namespace MvcMovie.Controllers
{
    public class HeThongPhanPhoiController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TenHeThong,DiaChi")] HeThongPhanPhoi heThongPhanPhoi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TenHeThong,DiaChi")] HeThongPhanPhoi heThongPhanPhoi)
        {
